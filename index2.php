        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-gradient-olive">
                    <div class="inner">
                        <h2><?php echo $jml_cust['jml_Vendor']; ?></h2>
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-gradient-info">
                    <div class="inner">
                        <h2><?php echo $tot_jud_film['jml_produk']; ?></h2>
...
<script type="text/javascript">
                    ...
                    $customer = "SELECT COUNT(DISTINCT(fp.Product_ID)) as Produk FROM fakta_pembelian fp JOIN time t on t.time_id = fp.time_ID GROUP BY t.tahun";
                    $i=1;
