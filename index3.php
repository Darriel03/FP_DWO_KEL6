...
<script type="text/javascript">
                    ...
                    $customer = "SELECT SUM(fp.Actual_Cost) as biaya FROM fakta_produksi fp JOIN time t on t.time_id = fp.Time_ID GROUP BY t.tahun";
                    $i=1;
